...
DOMAIN = "https://almalinux.org/"
DOWNLOAD_PAGE_URL = f"https://almalinux.org/get-almalinux/#ISO_Images"
FILE_NAME = "/AlmaLinux-[[VER]]-[[EDITION]]-dvd.iso"


class Alma(GenericUpdater):
    """
    ...
    def _get_download_link(self) -> str:
        ...
        return f"https://repo.almalinux.org/almalinux/{latest_version[0]}isos/x86_64/AlmaLinux-{'.'+latest_version[2] if len(latest_version)>2 else ''}-x86_64-[[EDITION]].iso"
